...
create-changelog:
	...
	echo "" >> CHANGELOG.md && \
	git log --no-decorate --pretty=format:"#### [%cs] [%(describe)]%n [%h](https://bitbucket.tools.3stripes.net/projects/LAK/repos/lakehouse-engine/commits/%H) %s" -n 1000 >> CHANGELOG.md
